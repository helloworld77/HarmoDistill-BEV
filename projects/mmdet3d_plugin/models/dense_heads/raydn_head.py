...
class RayDNHead(AnchorFreeHead):
    def __init__(self,
                 num_classes,
                 in_channels=256,
                 stride=[16],
        ...
        if class_weight is not None and (self.__class__ is RayDNHead):
        ...
        super(RayDNHead, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
