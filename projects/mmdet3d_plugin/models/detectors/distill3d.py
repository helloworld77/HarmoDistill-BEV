...
class Distill3D(MVXTwoStageDetector):
    """Distill3D."""
    ...
    def __init__(self,
                 ...
                 single_test=False,
                 pretrained=None):
        super(Distill3D, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def obtain_history_memory(self,
        ...
        for i in range(T):
            ...
            loss, outs_roi, outs = self.forward_pts_train(gt_bboxes_3d[i],
    ...
    def forward_train(self,
        ...
        losses, outs_roi, outs = self.obtain_history_memory(gt_bboxes_3d,
    ...
    def forward_distiller(self, return_loss=True, **data):
        ...
        if return_loss:
            for key in ['gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes', 'gt_labels', 'centers2d', 'depths', 'img_metas']:
                data[key] = list(zip(*data[key]))
            return self.forward_distill(**data)[0]
        else:
            return self.forward_test(**data)
